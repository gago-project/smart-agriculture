...
**文件**：`testdata/agent/soil-moisture/case-library.md`，在 Warning Cases 章节新增：
...
8. 新增单元测试文件，跑通
   ↓
9. case-library.md 新增 SM-WARN-003 ~ SM-WARN-006
```
...
| `testdata/agent/soil-moisture/case-library.md` | 修改 | 新增 SM-WARN-003 ~ SM-WARN-006 |
