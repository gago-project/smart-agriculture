"""Unit tests for the deterministic `/chat-v2` API."""

import unittest

from fastapi import HTTPException

from app.api.routers.chat import chat_v2
...
class ChatV2GuidanceService:
    async def reply(self, *args, **kwargs):
        ...
        return {
            ...
            "capability": "none",
            "final_text": "我可以帮你查墒情概况、地区/墒情仪/记录明细、按地区汇总，以及查看预警规则和模板。",
            "blocks": [
                {
                    "block_id": "block_guidance_1",
                    "block_type": "guidance_card",
                    "text": "我可以帮你查墒情概况、地区/墒情仪/记录明细、按地区汇总，以及查看预警规则和模板。",
