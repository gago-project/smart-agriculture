...
- MVP acceptance follows `testdata/agent/soil-moisture/formal-acceptance-library.md` plus the soil-moisture QA skill/rule assets.
...
- `testdata/agent/soil-moisture/`: Formal acceptance library, real-conversation library, and long-term soil-moisture test-source directory.
