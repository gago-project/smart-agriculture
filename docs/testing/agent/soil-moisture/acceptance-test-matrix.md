...
当前正式主库以 `130` 个 Case 为准，其中前 `36` 个来自 `2026-04-22` 商务评审版，后续又在同一主库内补充了业务加权样本与多轮话题边界专项样本。
...
以下内容如发生实现变更，建议在正式 Case 主库 之外做专项抽查，但不再单独维护为第二套正式 Case 库：
...
- 第一轮：先跑 `testdata/agent/soil-moisture/case-library.md` 中的 `130` 个正式 Case。
